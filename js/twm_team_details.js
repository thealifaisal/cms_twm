 ...
 function getTeamDet(){
   ...
   xhttp.open("POST", "http://192.168.10.4/cms/php/twm_team_details.php?TNAME="+team_name, true);
 ...
 function updateTeamDet(){
   ...
   var xhttp = new XMLHttpRequest();
   xhttp.open("POST", "http://192.168.10.4/cms/php/upd_twm_team_details.php?TNAME="+team_name+"+&TDET="+team_details, true);
   xhttp.onreadystatechange = function(){
     if(this.readyState == 4 && this.status == 200){
       if(this.responseText.includes("error")){
         alert("Server-Side Error\nError: " + this.responseText);
