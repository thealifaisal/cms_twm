        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">All Competition Heads</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php
                  ...
                  WHERE m.role_id = r.role_id AND m.nu_id = ce.head_nu_id
                  AND ce.comp_id = c.competition_id AND ce.event_id = e.event_id
                  ";
