        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">All Co-Heads</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php
                  ...
                  $q ="SELECT member.nu_id AS nu_id, full_name, gender , nu_email , role_name, year_join, comm_skill,tech_skill,mng_skill,team_player
                  FROM member, skill, role
                  WHERE member.nu_id = skill.nu_id AND member.role_id = role.role_id
                  AND
                  role_name LIKE 'Co-Head%';
                  ";
