...
// front-end-dev count
$sql = "SELECT * FROM member WHERE role_id = 123";
...
// back-end-dev count
$sql = "SELECT * FROM member WHERE role_id = 124";
...
$sql = "SELECT * FROM member WHERE role_id = 125";
...
// learners count
$sql = "SELECT * FROM member WHERE team_id IS NULL";
